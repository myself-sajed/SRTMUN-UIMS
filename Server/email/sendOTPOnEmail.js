      ...
      <tr style="vertical-align: top">
        <td style="word-break: break-word;border-collapse: collapse !important;vertical-align: top">
          ...
          <div class="u-row-container"
            style="padding: 0px;background-image: url('images/image-1.png');background-repeat: no-repeat;background-position: center top;background-color: #ffffff">
            <div class="u-row"
              style="Margin: 0 auto;min-width: 320px;max-width: 600px;overflow-wrap: break-word;word-wrap: break-word;word-break: break-word;background: rgb(131,58,180);
              background: linear-gradient(90deg, rgba(131,58,180,1) 0%, rgba(253,29,29,0.7816338205203957) 0%, rgba(252,176,69,0.7676282182794993) 100%); border-radius: 15px;">
              <div
                    ...
                    <div
                                ...
                                <tr>
                                  <td style="padding-right: 0px;padding-left: 0px;" align="center">
                                    ...
                                    <img align="center" border="0"
                                      src="https://upload.wikimedia.org/wikipedia/en/thumb/6/6d/SRTMUN_Logo_Official_Color_-PNG.png/900px-SRTMUN_Logo_Official_Color_-PNG.png?20220813084310"
                                      alt="" title=""
                      ...
                      <table id="u_content_heading_1" style="font-family:'Open Sans',sans-serif;" role="presentation"
                        ...
                        <tbody>
                          <tr>
                            <td class="v-container-padding-padding"
                              style="overflow-wrap:break-word;word-break:break-word;padding:2px 10px 0px 0px;font-family:'Open Sans',sans-serif;"
                              align="left">

                              <h1 class="v-font-size"
                                style="margin: 0px; line-height: 100%; text-align: center; word-wrap: break-word; font-weight: normal; font-family: 'Rubik',sans-serif; font-size: 22px;">
                                <div>
                                  <div>
                                    <div>
                                      <div>
                                        <div>
                                          <div>
                                            <div><strong>SWAMI RAMANAND TEERTH MARATHWADA
                                                UNIVERSITY<br /><br /><br /></strong></div>
                                          </div>
                                        </div>
                                      </div>
                                    </div>
                          ...
                          <tr>
                            <td class="v-container-padding-padding"
                              ...
                              <table height="0px" align="center" border="0" cellpadding="0" cellspacing="0" width="100%"
                                style="border-collapse: collapse;table-layout: fixed;border-spacing: 0;mso-table-lspace: 0pt;mso-table-rspace: 0pt;vertical-align: top;border-top: 1px solid #240707;-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%">
                                <tbody>
                                  <tr style="vertical-align: top">
                                    <td
                          ...
                          <tr>
                            <td class="v-container-padding-padding"
                              ...
                              <div style="line-height: 140%; text-align: center; word-wrap: break-word;">
                                ...
                                <p style="font-size: 14px; line-height: 140%;"><strong>${otp}</strong> is your OTP for
                                  registration as Faculty at <strong>SRTMUN-UMIS</strong>. Please enter to verify
                                  email now.</p>
