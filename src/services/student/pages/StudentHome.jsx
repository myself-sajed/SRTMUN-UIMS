...
const StudentHome = () => {
  ...
  const onSubmit = (e) => {
    ...
    setEdit(true);
    editReq(
      { id: itemToEdit, uploadProof, photoURL },
      "",
      initialstate,
      {
        ...values,
        ResearchGuide: ResearchGuide === "Other" ? otherGuide : ResearchGuide,
      },
      setValues,
      refetch,
      setOpen,
  ...
  const fetchFacutys = async () => {
    ...
    const userrefetch = await getReq({
      ...
      id: "",
      module,
      filter: { department: user.schoolName, salutation: "Dr." },
    });
    ...
    <div>
      ...
      <div className="mt-2">
        <Bred
          links={[
            siteLinks.welcome,
            isAlumniLink ? siteLinks.alumniHome : siteLinks.studentHome,
          ]}
        />
      </div>
            ...
            <div className="mb-3 md:mb-0 xl:h-screen">
              <div className="p-3 sm:flex flex-row xl:block items-start justify-start gap-4 bg-gray-50 rounded-lg border xl:h-full">
                <img
                  ...
                  className="h-[100px] w-[100px] sm:h-[150px] sm:w-[150px] xl:mx-auto rounded-full object-cover sm:mt-4 border- border-[#4566ac] sm:mx-10"
                />
                ...
                <div className="xl:mt-4">
                  ...
                  <div className="mt-3">
                    ...
                    <button
                      type="button"
                      className="text-black bg-yellow-300 hover:bg-yellow-400 font-medium rounded-lg text-sm p-2 text-center inline-flex gap-2 items-center mr-2 mb-2"
                      onClick={() => {
                        setOpen(true);
                        setEdit(true);
