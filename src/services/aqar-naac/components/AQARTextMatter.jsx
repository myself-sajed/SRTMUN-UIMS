...
// const AQARTextMatter = ({ matterMetaData, children }) => {

//     const { academicYear, matterType, userType } = matterMetaData

//     const [file, setFile] = useState(null)
//     const [proof, setProof] = useState(null)

//     const filter = { academicYear: academicYear, userType, matterType }
//     const { data, isLoading, refetch } = useQuery(`${matterType}-${academicYear}`, () => fetchSupportingDocuments(filter), { refetchOnWindowFocus: false })
