...
export default function AddButton({ title, onclick, exceldialog, yearFilter, setState, filterByAcademicYear }) {
    ...
    return (
        ...
        <div>
            ...
            {
                !filterByAcademicYear && <div style={{ display: "flex", justifyContent: "flex-end", marginTop: "5px" }}>
                    <AcadmicYearSelect className="col-md-3 col-lg-3 col-12" value={yearFilter} setState={setState} id="yearFilter" label="" />
                </div>
            }
