const TableData = {
  ...
  academicActivityParticipation: {
    ...
    { field: 'Select', keyName: "position", label: "Choose Position in Committee", options: ["Director", "Co-ordinator", "Member", "Other"] },
...
const categorywiseTables = {
  schoolInfoTables : {
      ...
      pgProgram : { title : 'PG Programs offered',tableInfo : TableData.programs},
      mphilProgramsSimple : { title : 'M.Phil Programs offered',tableInfo : TableData.programs},
      phdProgramSimple : { title : 'Ph.D. Programs offered',tableInfo : TableData.programs},
      ...
      listOfVisitingTeachers : { title : 'List of Visiting Fellows/Teachers, Adjunct and Emeritus Professors, (for last 4 years)',tableInfo : TableData.listOfVisitingTeachers},
  ...
  directorTables : {
      ...
      awardsAndPrizes : { title : 'Awards and Prizes received by students', tableInfo : TableData.Award},
      ...
      schoolSeminarOrganized : { title : 'Conferences / Seminar / Workshop Organized, State / University level', tableInfo : TableData.ConferencesSemiWorkshopOrganized, model : 'ConferencesSemiWorkshopOrganized'},
  ...
  cellAsInputTables : {
    teachingPosts : { title : 'Number of teaching posts sanctioned, filled and vacant', 
