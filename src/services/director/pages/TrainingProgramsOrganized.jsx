...
function TrainingProgramsOrganized({ filterByAcademicYear = false, academicYear }) {
  ...
  const title='Training Programs Organized';
  ...
  return (
    <>
      ...
      <BulkExcel data={data?.data} proof='Upload_Proof' sampleFile='TrainingProgramsOrganizedDirector' title={title} SendReq={SendReq} refetch={refetch} module={module} department={directorUser?.department} open={open} setOpen={setOpen} />
