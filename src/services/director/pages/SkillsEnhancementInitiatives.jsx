...
function SkillsEnhancementInitiatives({ filterByAcademicYear = false, academicYear }) {
    ...
    const title='Sckils Enhancement Initiatives';
    ...
    return (
        <>
            ...
            <BulkExcel data={data?.data} proof='Upload_Proof' sampleFile='SckilsEnhancementInitiativesDirector' title={title} SendReq={SendReq} refetch={refetch} module={module} department={directorUser?.department} open={open} setOpen={setOpen} />
