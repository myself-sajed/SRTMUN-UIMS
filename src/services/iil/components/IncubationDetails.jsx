            ...
            {isLoading ? <UserLoading title="Getting data" /> : <form onSubmit={onSubmit}>
                <div className="w-full mb-4 border border-gray-200 rounded-lg bg-gray-50 dark:bg-gray-700 dark:border-gray-600">
                    <div className="px-4 py-2 bg-white rounded-t-lg dark:bg-gray-800">
                        ...
                        <textarea value={details} onChange={(e) => setDetails(() => e.target.value)} id="comment" rows="4" className="w-full px-0 text-sm text-gray-900 bg-white border-0 outline-none" placeholder="Write a comment..." required></textarea>
                    </div>
