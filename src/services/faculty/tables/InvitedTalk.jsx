...
const tableHead = {
    ...
    return (
        <div>
            ...
            <BulkExcel data={data?.data?.data} proof='proof' tableHead={tableHead} typeObject={typeObject} commonFilds={{userId:user?._id}} sampleFile='InvitedTalkFaculty' title='Invited Talk' SendReq='InvitedTalk' refetch={refetch} module='faculty' department={user?._id} open={open} setOpen={setOpen} />
