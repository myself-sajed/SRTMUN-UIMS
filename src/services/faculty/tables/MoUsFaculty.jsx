...
import { tableHead } from '../../admin/tables_director/MoUs'
...
const MoUsFaculty = ({ filterByAcademicYear = false, academicYear, showTable = true, title }) => {
    ...
    const typeObject = {
        Name_of_Organisation_with_whome_mou_signed: "text", Duration_of_MoU: "text", Year_of_signing_MoU: academicYearGenerator( 29, true, true ),
    }
    ...
    return (
        <div>
            ...
            <BulkExcel data={data?.data} proof='Upload_Proof' tableHead={tableHead} typeObject={typeObject} commonFilds={{userId:user?._id, SchoolName:user?.department}} title='MoUs' SendReq='MoUs' refetch={refetch} module='director' open={open} setOpen={setOpen} />
