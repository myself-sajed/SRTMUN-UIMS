...
const generateCASReport = (casData, userData, selectedYear, setReportLoading) => {
    try {

        Axios.post(`${process.env.REACT_APP_MAIN_URL}/generatePBASReport`, { casData, userData, selectedYear })
            .then(function (res) {
