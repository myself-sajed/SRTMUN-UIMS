      ...
      <Dialog open={dataFilterModal.isOpen} onClose={onClose} fullWidth maxWidth='md'>
        ...
        <DialogContent>
          {model === 'MainBookAndChapter' && <div>
            <div class="flex p-4 mb-4 text-sm text-yellow-800 rounded-lg bg-yellow-50 dark:bg-gray-800 dark:text-yellow-400" role="alert">
              <svg aria-hidden="true" class="flex-shrink-0 inline w-5 h-5 mr-3" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7-4a1 1 0 11-2 0 1 1 0 012 0zM9 9a1 1 0 000 2v3a1 1 0 001 1h1a1 1 0 100-2v-3a1 1 0 00-1-1H9z" clip-rule="evenodd"></path></svg>
              <span class="sr-only">Info</span>
              <div>
                <span class="font-medium">Please take following points into consideration</span>
                <ul class="mt-1.5 ml-4 list-disc list-inside">
                  <li> <span class="font-medium">Book Chapters:</span> If the chapters from the same book exceeds above 2, only first 2 will be considered for scoring, others will be filtered out.</li>
                  <li> <span class="font-medium">Translation Work:</span> If the translation work from the same book exceeds 3, only first 3 will be considered for scoring, others will be filtered out.</li>
                </ul>
              </div>
            </div>
          </div>
