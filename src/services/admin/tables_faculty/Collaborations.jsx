...
const tableHead ={index:'Sr.No.', 'userId.name': 'Faculty Name','userId.department': 'Faculty School',collabTitle: 'Title of the collaborative activity',agencyName: 'Name of the collaborating agency with contact details',participantName: 'Participant Name',collabYear: 'Year of Collaboration',duration: 'Duration',activityNature: 'Nature of the activity',year: 'Year', proof: 'Uploaded Proof'}
