...
const BtnAdminTable = ({ module = "Admin", proof = null, color = "#ae7e28", model, academicYear, heading, school, serviceName, customParams, setState, setLoaded, values }) => {
  ...
  const { data, isLoading, refetch } = useQuery(`${model}`, () => getReq(params))
