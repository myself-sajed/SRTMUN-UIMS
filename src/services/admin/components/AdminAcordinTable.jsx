...
const AdminAcordinTable = ({ children, Heading, data, SendReq, proof, tableHead, year, module, isLoading }) => {
  ...
  return (
    <div className='col-md-4 col-12 col-lg-3 col-sm-6 p-2'>
      ...
      <Btn className='hover:text-[#997024]' sx={{ background: "#f3e9d5",color:"#997024", width: "100%"}} size="small" onClick={()=>{setOpen(true)}} >{Heading}</Btn><AdminExcelExoprt data={data} fileTitle={Heading} SendReq={SendReq} module={module} proof={proof} />
      </div>
