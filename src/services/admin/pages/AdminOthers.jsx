...
const AdminOthers = () => {
  ...
  const allOtherComponents = [
    ...
    {
      element: <BtnAdminTable model="SwayamDetailsOfOnlineCourses" setState={setChildData} customParams={{ model: "SwayamDetailsOfOnlineCourses", module: "Admin", filter: { year: { $in: yearFilter } } }} heading='Details of online courses (Swayam)' setLoaded={setLoaded} serviceName="swayam" proof="proof" />,
