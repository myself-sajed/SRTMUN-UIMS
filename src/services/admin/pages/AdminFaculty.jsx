...
const AdminFaculty = () => {
  ...
  const allFacultyComponents = [
    ...
    },
    {
      ...
      childData: childData?.awardrecognition, filename: 'Award Recognition.csv', SendReq: "AwardRecognition", proof: "proof", module: "faculty"
    },
    {
    ...
    },
    {
      ...
      childData: childData?.conferencepartipeted, filename: 'Conference Participated.csv', SendReq: "ConferenceParticipated", proof: "proof", module: "faculty"
    },
    {
