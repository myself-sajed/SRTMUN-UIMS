...
const EsttFullTimeTeacher = () => {
  ...
  const typeObject = { name: "text", idNumber: "text", email: "text", gender: "text", designation: "text", natureOfPost: Lists.esttNature, dateOfJoining: "date", academicYear: academicYearGenerator(29, true, true) };
