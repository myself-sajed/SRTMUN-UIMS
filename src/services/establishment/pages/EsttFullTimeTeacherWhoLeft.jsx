...
const EsttFullTimeTeacherWhoLeft = ({ filterByAcademicYear = false }) => {
  ...
  const typeObject = { name: "text", idNumber: "text", yearInWhich: "number", email: "text", gender: "text", designation: "text", natureOfPost: Lists.esttNatureOfPost, dateOfJoining: "date", dateOfLeaving: "date", academicYear: academicYearGenerator(29, true, true) };
