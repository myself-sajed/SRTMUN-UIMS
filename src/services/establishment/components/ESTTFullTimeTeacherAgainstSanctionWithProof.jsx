...
const ESTTFullTimeTeacherAgainstSanctionWithProof = ({ academicYear }) => {

    const [file, setFile] = useState(null)
    const [proof, setProof] = useState(null)

    const filter = { academicYear, userType: 'estt', proofType: 'ESTTFullTimeTeacherAgainstSanction' }
    const { data, isLoading, refetch } = useQuery(`ESTTFullTimeTeacherAgainstSanction-${academicYear}`, () => fetchSupportingDocuments(filter), { refetchOnWindowFocus: false })
    ...
    const submitProofFunction = () => {
        ...
        formData.append('proofType', 'ESTTFullTimeTeacherAgainstSanction')
    ...
    return <div>
        {
            isLoading ? <UserLoading title="Fetching details..." />
                ...
                <div>
                    ...
                    <EsttFullTimeTeacherAgainstSanctioned filterByAcademicYear={academicYear} />
...
export default ESTTFullTimeTeacherAgainstSanctionWithProof
