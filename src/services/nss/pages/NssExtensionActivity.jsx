...
const NssExtensionActivity = ({ filterByAcademicYear = false }) => {
  const model = 'ExtensionActivities'
  const module = 'nssd';
  const title = "Extension Activities";


  let filter = filterByAcademicYear ? { SchoolName: "NSS", Year_of_activity: filterByAcademicYear } : { SchoolName: "NSS" };
